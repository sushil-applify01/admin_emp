const globalConstants = {
	...
	EMAIL: {
		LOCAL: {
			MAIL_SERVICE: "Gmail",
			FROM_EMAIL: "techsushil66@gmail.com",
			LINK:"http://localhost:3001/reset/${token}/${user.id}",
			SMTP_CREDENTIALS: {
				email: "techsushil66@gmail.com",
				password: "bfemcnrgkhdifybk"
			}
		},
		PROD: {
			MAIL_SERVICE: "Gmail",
